...
import com.example.navigatorjetpack.databinding.FragmentHomeBinding
    ...
    override fun onCreateView(
        ...
        binding.button.setOnClickListener{
            ...
            if(!TextUtils.isEmpty(binding.editTextTextPersonName.text.toString())){
                val bundle: Bundle = bundleOf("user_name" to binding.editTextTextPersonName.text.toString())
